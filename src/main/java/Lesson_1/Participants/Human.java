...
public class Human implements Participant {
    ...
    public boolean run(Obstacle obs, boolean consoleOut) {
        ...
        if (consoleOut) {
            System.out.printf("Человек \"%s\" %sсмог пробежать препятствие%n", getName(), result ? "" : "не ");
    ...
    public boolean jump(Obstacle obs, boolean consoleOut) {
        ...
        if (consoleOut) {
            System.out.printf("Человек \"%s\" %sсмог перепрыгнуть препятствие%n", getName(), result ? "" : "не ");
